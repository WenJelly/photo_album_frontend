...
export const SPHERE_PREFETCH_VIEWPORT_OFFSET_PX = 320
export const SPHERE_PREFETCH_ROOT_MARGIN =
  `${SPHERE_PREFETCH_VIEWPORT_OFFSET_PX}px 0px ${SPHERE_PREFETCH_VIEWPORT_OFFSET_PX}px 0px`
